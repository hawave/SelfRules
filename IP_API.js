...
var countries = new Map([[ "台湾" , "台湾省" ]])
var body = $response.body;
var obj = JSON.parse(body);
var title = flags.get(obj['countryCode']) + ' ' + countries.get(obj['country']);
// var subtitle = ValidCheck(obj['city'])+' - '+'('+obj['org']+')';
var subtitle = ORGValidCheck(obj['org']);
var ip = obj['query'];
...
// var description = 'IP: '+ obj['query'] + '\n' + '地区: '+obj['country'] + ' ' + ValidCheck(obj['regionName']) + '\n' + '服务商: '+ ValidCheck(obj['isp']);
var description = 'IP: ' + obj['query'] + '\n' + '地区: ' + countries.get(obj['country']) + ' ' + ValidCheck(obj['regionName']) + '\n' + '服务商: ' + fws(obj['org']);
